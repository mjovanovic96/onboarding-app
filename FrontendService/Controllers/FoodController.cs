...
namespace FrontendService.Controllers
{
    public class FoodController : Controller
    {
        ...
        public FoodController(HttpClient httpClient, FabricClient fabricClient, StatelessServiceContext statelessServiceContext)
        {
        ...
        {
            Uri serviceName = FrontendService.GetFoodMenuServiceName(this.serviceContext);
