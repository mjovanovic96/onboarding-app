...
using FoodMenuService;
using OrderCartService;
...
namespace FrontendService.Controllers
{
    public class OrderCartController : Controller
    {
        ...
        public OrderCartController(HttpClient httpClient, FabricClient fabricClient, StatelessServiceContext statelessServiceContext)
        {
        ...
        {
            Uri serviceName = FrontendService.GetOrderCartServiceName(this.serviceContext);
        ...
        private async Task<string> ResolveOrderCartAddress()
        {
            ...
            Console.WriteLine("Address is {1}", addressString);
